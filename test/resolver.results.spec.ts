...
describe("Result resolver", () => {
  ...
  it("should return the correct result given countries and a date", () => {});

  it("should return the correct results given countries and a minimum date", () => {});
  it("should return the correct results given countries and a maximum date", () => {});
});
